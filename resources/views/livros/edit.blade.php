...
@section('content')
    ...
    @if ($errors->any())
        <div class="alert alert-danger">
            <strong>Whoops!</strong> Ocorreu um problema com a sua entrada.<br><br>
            <ul>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="descricao" placeholder="Descrição">{{ $livro->descricao }}</textarea>
                </div>
            </div>
